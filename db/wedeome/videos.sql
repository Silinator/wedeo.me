...
CREATE TABLE `videos` (
  ...
  `fileUvid` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `videos` (`uvid`, `fileUvid`, `title`, `uuid`, `duration`, `views`, `commentsCount`, `likes`, `dislikes`, `orgResolution`, `description`, `tags`, `resolutions`, `color`, `language`, `category`, `lastUpdate`, `uploadStart`, `publishDate`, `privacy`, `status`) VALUES
