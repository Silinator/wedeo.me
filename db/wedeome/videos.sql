...
INSERT INTO `videos` (`vuid`, `datavuid`, `title`, `uuid`, `duration`, `views`, `orgResolution`, `description`, `tags`, `resolutions`, `color`, `language`, `category`, `lastUpdate`, `uploadStart`, `publishDate`, `privacy`, `status`) VALUES
