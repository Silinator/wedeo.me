Vue.component( 'watch', {
  template: `
  <div class='mainWedeoContainer flex flex-col sm:flex-row justify-between w-screen gap-5 max-w-full mt-16 pt-4 pr-4 pb-11 pl-4 overflow-x-hidden'>
  ...
  mounted() {
    if( typeof this.wedeoPlayer.type === "undefined" || this.wedeoPlayer.type === "mini" ) {
      ...
      window.onresize = function() { if( wedeoPlayer ){ wedeoPlayer.resizeWedeo(); } };
